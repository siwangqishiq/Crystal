...
public final class GameOver
{
    ...
    public void reInit()
    {
        ...
        distionation_x = (GameScreen.SC_WIDTH>>1)-(int)(gameover_sprite.getWidth()/2);
        distionation_y = GameScreen.SC_HEIGHT-200-(int)gameover_sprite.getHeight();
